...
export const departmentSchema = z.object({
  name: z
    ...
    .max(255, "نام حداکثر ۲۵۵ کاراکتر می‌تواند باشد"),
...
export const workflowSchema = z
  .object({
    title: z
      ...
      .max(255, "عنوان حداکثر ۲۵۵ کاراکتر می‌تواند باشد"),
    description: z.string().nullable().optional(),
    ...
    priority: z.coerce
      .number()
      .int()
      .min(1, "اولویت باید بین ۱ تا ۴ باشد")
      .max(4, "اولویت باید بین ۱ تا ۴ باشد")
      .default(1),
    startDate: z
      .string()
...
export const taskSchema = z.object({
  ...
  estimatedHours: z.coerce
    .number()
    .int()
    .min(1, "ساعت تخمینی باید حداقل ۱ باشد")
    .nullable()
    .optional(),
});
...
export const registerSchema = z
  .object({
    ...
    password: z
      ...
      .max(255, "رمز عبور حداکثر ۲۵۵ کاراکتر می‌تواند باشد"),
