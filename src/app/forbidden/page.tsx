  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-900 px-4 text-center">
      <div className="mb-6 flex items-center gap-3">
        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-slate-600 to-slate-800 text-lg text-white">
      ...
      <p className="mt-3 max-w-md text-sm text-slate-400">
        شما به این بخش دسترسی ندارید. برای دسترسی به این صفحه باید نقش مناسب داشته باشید.
      </p>

      <Link
        href="/dashboard"
        className="mt-8 inline-flex items-center gap-2 rounded-lg bg-slate-700 px-6 py-3 text-sm font-medium text-white transition hover:bg-slate-600"
      >
