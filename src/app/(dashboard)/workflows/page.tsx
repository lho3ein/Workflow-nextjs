...
export default async function WorkflowsPage({ searchParams }: Props) {
  ...
  return (
    <div>
      <PageHeader
        title="گردش کارها"
        subtitle="مدیریت فرآیندها و گردش کارهای سازمان"
        icon="fa-solid fa-diagram-project"
        buttonLabel="ایجاد گردش کار"
        buttonHref="/workflows/new"
      />

      <Card>
        <CardHeader
          title="لیست گردش کارها"
          subtitle={`${formatNumber(total)} گردش کار ثبت شده`}
