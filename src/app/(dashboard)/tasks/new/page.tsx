...
export default async function NewTaskPage() {
   ...
   return (
      <div>
         <PageHeader title="ایجاد تسک" subtitle="تسک جدیدی به گردش کار اضافه کنید" icon="fa-solid fa-list-check" />

         <Card className="max-w-2xl">
            <CardHeader title="مشخصات تسک" subtitle="فیلدهای ستاره‌دار الزامی هستند" icon="fa-solid fa-clipboard-list" />
            <CardBody>
