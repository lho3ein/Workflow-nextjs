...
export default async function DepartmentShowPage({ params }: Props) {
   ...
   return (
      <div>
         <PageHeader title={department.name} subtitle="مشخصات و گردش کارهای دپارتمان" icon="fa-solid fa-building-columns" />
         ...
         <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
               ...
               <Card>
                  ...
                  <CardBody>
                        ...
                        {infoItems.map((item) => (
                           <div key={item.label} className="flex items-start gap-3">
                              ...
                              <div className="min-w-0">
                                 ...
                                 <dd className="mt-0.5 text-sm font-medium text-slate-700" dir={item.ltr ? "ltr" : undefined} style={item.ltr ? { textAlign: "right" } : undefined}>
                                    {item.value}
                                 </dd>
                              </div>
                           </div>
                     ...
                     <div className="mt-5 flex items-center gap-2 border-t border-slate-100 pt-4">
                        <Link href={`/departments/${department.id}/edit`} className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg bg-sky-50 px-4 py-2 text-sm font-medium text-sky-700 transition hover:bg-sky-100">
                           <i className="fa-solid fa-pen" />
                           ویرایش
                        </Link>
                        <DeleteButton id={department.id} entityName="دپارتمان" endpoint="/api/departments" redirectTo="/departments" />
                     </div>
                  </CardBody>
               </Card>
            </div>
            ...
            <div className="lg:col-span-2">
               <Card>
                  <CardHeader title="گردش کارهای دپارتمان" subtitle="لیست گردش کارهای این دپارتمان" icon="fa-solid fa-diagram-project" />
